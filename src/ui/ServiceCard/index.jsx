  ...
  return (
    ...
    style={{"--color-primary": color, "--color-primary-rgb": colorRGB}}>
        <div className="service__card-top">
            <div className="ball__overlay ball ball1"></div>
            <div className="ball__overlay ball ball2"></div>
            <div className="ball__overlay ball ball3"></div>
            <div className="ball__overlay ball ball4"></div>
            <div className="ball__overlay ball ball5 flex__center">{icon}</div>
        </div>
